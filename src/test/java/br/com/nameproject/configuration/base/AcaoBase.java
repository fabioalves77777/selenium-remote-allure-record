...
public class AcaoBase {
	...
	/**
	 * Método para verificar se texto do elemento contém no texto esperado
	 */
	...
	/**
	 * Método que espera a página carregar completamente
	 */
	...
	/**
	 * Método que printa tela no Allure Report
	 */
	@Attachment(value = "Page screenshot", type = "image/png")
	public byte[] screenshot(WebDriver driver) {
		esperaPaginaCarregar(driver);
